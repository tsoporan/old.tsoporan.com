...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('portfolio_project', 'ordering', self.gf('django.db.models.fields.PositiveIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Project.ordering'
        db.delete_column('portfolio_project', 'ordering')
