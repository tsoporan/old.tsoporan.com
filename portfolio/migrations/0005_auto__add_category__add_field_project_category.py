...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('portfolio_project', 'category', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['portfolio.Category']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column('portfolio_project', 'category_id')
